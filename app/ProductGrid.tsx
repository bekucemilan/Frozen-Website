...
// deterrent ringan buat foto produk: blok klik-kanan/save-as & drag.
// Watermark "Cemilan Beku" sendiri sudah dibakar permanen ke file fotonya
// (di controller, pas upload), jadi tetap ada walau foto ini didownload.
            ...
            >
              <div className="product-photo">
                {cover ? (
                  ...
                  <img src={cover} alt={p.name} draggable={false} onContextMenu={blockContextMenu} />
                ) : (
                ...
                <>
                  ...
                  <div className="modal-thumbs">
                    {gallery.map((g, i) => (
                      ...
                      >
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img src={g} alt="" draggable={false} onContextMenu={blockContextMenu} />
                      </button>
                    ))}
                  </div>
                </>
