...
export default function ProductGrid({
  ...
  const orderLink = active && waLink
    ? (() => {
        const unit = unitPriceForQty(active.price, active.wholesale_tiers || [], modalQty);
        ...
        <div className="modal-backdrop" onClick={() => setActiveId(null)}>
          <div className="modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              {active.wholesale_tiers && active.wholesale_tiers.length > 0 && (
              ...
              <div className="modal-qty-row">
                ...
                <span className="modal-qty-subtotal">
                  Rp {formatPrice(unitPriceForQty(active.price, active.wholesale_tiers || [], modalQty) * modalQty)}
                </span>
              </div>
              ...
              <div className="modal-order-actions">
                <button
                  ...
                  onClick={() => addItem(active, modalQty)}
                >
